...
class ReservaController extends AppController
{
    ...
    public function index()
    {
        $query = $this->Reserva->find()
            ->contain(['Cliente', 'Funcionario', 'Quarto']);
    ...
    {
        $reserva = $this->Reserva->get($id, contain: ['Cliente', 'Funcionario', 'Quarto', 'Hospedagem']);
        $this->set(compact('reserva'));
    }
    ...
    public function add()
    {
        ...
        $this->set(compact('reserva', 'cliente', 'funcionario', 'quarto'));
    }
